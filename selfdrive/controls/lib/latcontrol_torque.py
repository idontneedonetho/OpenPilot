...
class LatControlTorque(LatControl):
  def __init__(self, CP, CI):
    ...
    if self.use_nnff:
      ...
      self.nn_friction_override = CI.lat_torque_nn_model.friction.override
      ...
      self.history_check_offsets = [history_check_frames[0] - i for i in history_check_frames]
